...
public class LocationServiceContractTest {
    ...
    public void testFor_existingZipCode_shouldYieldLocationData() {
        ...
        assertThat(location.getPlaces()).hasSize(1)
                .extracting(Place::getPlaceName, Place::getCounty, Place::getState, Place::getStateAbbreviation)
                .containsExactly(Tuple.tuple(PLACE_NAME, COUNTY, STATE, STATE_ABBREVIATION));
    }
